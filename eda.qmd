...
increased comparatively higher in this period and the distribution became flat with outliers in the both end.
...
Producer price index (PPI) is a measure of inflation containing prices of a basket of goods paid to producers and aim to measure wholesale inflation. Therefore, year over year percentage change in PPI gives us the yearly changes in wholesale prices of the firms in the economy.

For each sector, average increases in producer prices (aka input costs) is calculated and given in the table below.

Table shows average increases in prices of sectors in Turkey from 2017 to 2021.
...
-   Information sector is the one experiencing the lowest price increase in its prices
