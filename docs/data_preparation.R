...
#company_info$sector_name <- company_info$sector %>% gsub(".-", "", .)
...
# Read Exports  Data
export <- read_excel("Project_data_exports.xlsx", 
                     range = "A5:D854")
...
# Read Imports Data
import <- read_excel("Project_data_imports.xlsx", 
                     range = "A5:D854")
...
# Read PPI Data
ppi_1 <- read_excel("Project_data_ppi_new.xlsx", 
                     range = "A4:AH158")
...
employment_male <- 
  read_excel("Project_data_employment.xlsx", 
             range = "Z6:AW14")
employment_female <-
  read_excel("Project_data_employment.xlsx", 
             range = "AY6:BW14")
...
labor_cost_index <- 
  read_excel("Project_data_labor_cost_index.xlsx", 
             range = "A4:P54")
...
company_bs <- read_excel("Project_data_b_s.xlsx", 
                         range = "A4:O4032",  
...
company_is <- read_excel("Project_data_i_s.xlsx", 
                         range = "A4:O921",  
                         col_names = c("sector_code", "accounts", 2009:2021))
