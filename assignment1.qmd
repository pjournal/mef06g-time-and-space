...
startup %>% 
  ...
  scale_y_continuous(labels = comma_format(big.mark = ".",
                                           decimal.mark = ",")) +
  labs(x = "Deal Announcement Date", y = "Total Deal Value (USD)", title = "Monthly Investments to Startups in 2021") + 
  theme_bw()
```
...
startup_percent_group %>% 
  ...
  labs(x = "Target Company", y = "Percentage (%)", title = "Concentration of Investments among Startups in 2021") +
  theme_bw()
