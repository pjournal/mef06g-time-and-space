...
kable(top_5_sector_table, format.args = list(big.mark = "."))
...
startup %>% 
  ...
  scale_y_continuous(labels = comma_format(big.mark = ".",
                                           decimal.mark = ","))+
  ggtitle("Monthly Total Investment Amounts / Sector in USD ")
```
...
# Graph investment deals and number of transactions for top 10 investor origin countries in 2021
startup_country_graph %>% 
  ...
  scale_y_continuous(labels = comma_format(big.mark = ".",
                                           decimal.mark = ","))+
  ggtitle("Top Investing Countries (Total Amount in USD) ")
...
startup_country_graph %>% 
  ...
  scale_y_continuous(labels = comma_format(big.mark = ".",
                                           decimal.mark = ","))+
  ggtitle("Top Investing Countries (# of Investments) ")
```
